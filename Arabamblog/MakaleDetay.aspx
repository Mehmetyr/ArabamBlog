<%@ Page Title="" Language="C#" MasterPageFile="~/MaterPage.Master" AutoEventWireup="true" CodeBehind="MakaleDetay.aspx.cs" Inherits="Arabamblog.MakaleDetay" %>
    ...
    <div style="min-height: 500px;">
        <div class="yorum" style="margin-top:50px;">
            ...
            <asp:Panel ID="pnl_girisyok" runat="server" style="margin:20px 0;">
                <h2>Yorum yapabilmek için lütfen <a href="UyeGirisi.aspx">giriş yapınız </a></h2>
            </asp:Panel>
