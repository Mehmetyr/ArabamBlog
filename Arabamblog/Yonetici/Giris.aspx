<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giris.aspx.cs" Inherits="Arabamblog.Yonetici.Giris" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Arabam Blog Yönetici Panel Girişi</title>
        ...
        <div class="FormContainer">
            ...
            <div class="contentcontainer">
                ...
                <div>
                    ...
                    <asp:TextBox ID="tb_sifre" runat="server" TextMode="Password" CssClass="metinKutu" placeholder="Şifre"></asp:TextBox>
                </div>
                <div>
